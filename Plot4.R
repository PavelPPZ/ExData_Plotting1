...
plot4 <- function() {
        ...
        df_sel$Voltage <- as.numeric(df_sel$Voltage)
        df_sel$Global_reactive_power <- as.numeric(df_sel$Global_reactive_power)
        ...
        ## plot 1,2
        plot(df_sel$Full_time,df_sel$Voltage, type = "l", xaxt ="n", xlab="datetime", ylab="")
        ...
        ## plot 2,2
        plot(df_sel$Full_time,df_sel$Global_reactive_power, type = "l", xaxt ="n", xlab="datetime", ylab="")
